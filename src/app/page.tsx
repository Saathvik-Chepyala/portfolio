      ...
      <section id="projects" className="py-20 px-4 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-2xl font-bold mb-3">Staffing Tracker</h3>
              <p className="text-gray-300 mb-4">Internal tool built with ServiceNow's BuildTools to streamline engineering resourcing.</p>
            ...
            <motion.div
              ...
              className="bg-gray-700 rounded-lg p-6"
            >
              <h3 className="text-2xl font-bold mb-3">Insurance-Dentist Finder App</h3>
              <p className="text-gray-300 mb-4">Full-stack React Native app to help patients find in-network dentists based on insurance coverage.</p>
              <div className="flex flex-wrap gap-2">
